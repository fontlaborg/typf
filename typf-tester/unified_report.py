#!/usr/bin/env python3
"""
Unified Analysis Report Generator for TYPF
...
class UnifiedReport:
    ...
    def generate_markdown_report(self) -> str:
        ...
        # Build report
        lines = []
        lines.append("# TYPF Unified Analysis Report")
        lines.append("")
        ...
        if pixel_diff_data:
            ...
            lines.append("Consider using **orge** or **skia** for consistent results.")
            lines.append("")
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Report generated by TYPF Unified Analysis*")
        lines.append("")
    ...
    def save_reports(self):
        ...
        print("\n📊 TYPF Unified Analysis Report Generator")
        print("=" * 80)

        # Generate markdown report
        markdown = self.generate_markdown_report()
        md_path = self.output_dir / "unified_analysis.md"
        ...
        json_path = self.output_dir / "unified_analysis.json"
