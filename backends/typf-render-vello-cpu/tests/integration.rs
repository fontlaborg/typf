//! Integration tests for Vello CPU renderer
//!
//! Tests rendering with real fonts and verifies output format/structure.

// this_file: backends/typf-render-vello-cpu/tests/integration.rs
...
use typf_render_vello_cpu::{VelloCpuConfig, VelloCpuRenderer};
...
#[test]
fn test_vello_cpu_renderer_creation() {
    let renderer = VelloCpuRenderer::new();
    assert_eq!(renderer.name(), "vello-cpu");
}

#[test]
fn test_vello_cpu_render_with_real_font() {
...
#[test]
fn test_vello_cpu_render_empty_text() {
    let font = match load_font("NotoSans-Regular.ttf") {
        Some(f) => f,
        None => return,
    };
...
#[test]
fn test_vello_cpu_render_different_sizes() {
    let font = match load_font("NotoSans-Regular.ttf") {
        Some(f) => f,
        None => return,
    };
...
#[test]
fn test_vello_cpu_bitmap_stability() {
    let font = match load_font("NotoSans-Regular.ttf") {
        Some(f) => f,
        None => return,
    };
...
#[test]
fn test_vello_cpu_supports_format() {
    let renderer = VelloCpuRenderer::new();
...
#[test]
fn test_vello_cpu_with_custom_config() {
    let config = VelloCpuConfig {
        hinting: false,
        ..Default::default()
    };
    let renderer = VelloCpuRenderer::with_config(config);
    assert_eq!(renderer.name(), "vello-cpu");
}

#[test]
fn test_vello_cpu_render_arabic_font() {
...
#[test]
fn test_vello_cpu_render_variable_font() {
...
#[test]
fn test_vello_cpu_render_colr_color_font() {
...
#[test]
fn test_vello_cpu_render_cbdt_color_font() {
...
#[test]
fn test_vello_cpu_render_sbix_color_font() {
...
#[test]
fn test_vello_cpu_render_math_font() {
