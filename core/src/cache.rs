...
use crate::shaping_cache::ShapingCacheKey;
use moka::sync::Cache;
...
/// Global, lazily initialized instance of the cache manager.
...
impl CacheManager {
    ...
    /// Clears all entries in both shaping and glyph caches, and resets their statistics.
